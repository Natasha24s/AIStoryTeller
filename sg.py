...
def handler(event, context):
    ...
    try:
        ...
        # Prepare response data - Modified to match Step Functions expected format
        response_data = {
            'story_id': story_id,
            'topic': user_input,
            'scenes': scenes,
        ...
        # Return the response in the format Step Functions expects
        return response_data  # Remove the API Gateway wrapper
